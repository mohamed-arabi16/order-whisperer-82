...
const base = readLoose("en.original.json");
const incoming = readLoose("en.jules.json");

const merged = merge(base, incoming);

writeJSON("merged_en.json", merged);

// Report
let report = "# Merge Report (en)\n\n";
...
console.log("Done → merged_en.json + merge_report.md");
