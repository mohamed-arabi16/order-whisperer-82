...
/**
 * A container for a chart, providing a context with the chart's configuration.
 */
...
/**
 * A component that generates a style tag to apply the chart's color configuration.
 */
